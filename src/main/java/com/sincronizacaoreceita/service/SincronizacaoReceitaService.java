...
public class SincronizacaoReceitaService {
	...
	/**
	 * Realiza sincronizacao das informaçoes através do serviço da receita {@link ReceitaService}.
	 * 
	 * @param contas
	...
	public List<ContaBean> realizarSincronizacao(List<ContaBean> contas) {
		...
		try {
			...
			for(ContaBean conta: contas) {
				...
				boolean resultado = receitaService.atualizarConta(conta.getAgencia(), contaFormatada, saldoFormatado, conta.getStatus());
